---
title: "Repro - What Makes a Strong Model? A Unified Spectral Analysis of Knowledge Transfer (ykWN4LG9vE)"
emoji: 🎯
colorFrom: yellow
colorTo: red
sdk: static
...
- [Claim-by-claim release report](reports/spectral-transfer-reproduction/release-report.md)
- [Evaluator-visible evidence matrix](reports/spectral-transfer-reproduction/visibility-matrix.md)
- [Evaluator-blind red-team record](audit/red-team-review.md)
- [Final evaluator-only traversal](audit/visibility-traversal-final.json)
- [Canonical evaluator entrypoint](pages/index.md)
...
| 5 — real architectures / stopping | VERIFIED | ResNet18 327.44 vs CLIP 90.92; epoch 2 beats epoch 20 with positive paired CI |
